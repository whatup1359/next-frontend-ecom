      ...
      <div className={`p-4 sm:p-8.5 ${dropdown ? "block" : "hidden"}`}>
        <div className="mb-5">
          ...
          <div className="relative">
            <select className="w-full bg-gray-1 rounded-md border border-gray-3 text-dark-4 py-3 pl-5 pr-9 duration-200 appearance-none outline-none focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20">
              ...
              <option value="1">สหรัฐอเมริกา</option>
        ...
        <div className="mb-5">
          ...
          <input
            type="text"
            name="address"
            placeholder="บ้านเลขที่ หมู่ที่"
          ...
          <div className="mt-5">
            <input
              type="text"
              name="address"
              placeholder="ห้องหรือหมู่บ้าน หมู่ที่"
              className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
            />
          </div>
        </div>
        ...
        <div className="mb-5">
          <label htmlFor="town" className="block mb-2.5">
            ตำบล/แขวง <span className="text-red">*</span>
          </label>
        ...
        <div className="mb-5">
          <label htmlFor="country" className="block mb-2.5">
            อำเภอ/เขต <span className="text-red">*</span>
          </label>
