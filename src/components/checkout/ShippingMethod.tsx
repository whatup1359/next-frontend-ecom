  ...
  return (
    <div className="bg-white shadow-1 rounded-[10px] mt-7.5">
      <div className="border-b border-gray-3 py-5 px-4 sm:px-8.5">
        <h3 className="font-medium text-xl text-dark">รูปแบบการจัดส่ง</h3>
      </div>
            ...
            <div className="rounded-md border-[0.5px] py-3.5 px-5 ease-out duration-200 hover:bg-gray-2 hover:border-transparent hover:shadow-none">
              <div className="flex items-center">
                ...
                <div className="border-l border-gray-4 pl-4">
                  ...
                  <p className="text-custom-xs">จัดส่งสินค้าโดย FedEx</p>
                </div>
              </div>
            </div>
          </label>
            ...
            <div className="rounded-md border-[0.5px] py-3.5 px-5 ease-out duration-200 hover:bg-gray-2 hover:border-transparent hover:shadow-none">
              <div className="flex items-center">
                ...
                <div className="border-l border-gray-4 pl-4">
                  ...
                  <p className="text-custom-xs">จัดส่งสินค้าโดย DHL</p>
                </div>
              </div>
            </div>
          </label>
